...
function gencell_enqueue() {
    ...
    //Scripts
	wp_register_script('gencell_jquery', plugins_url('assets/js/jquery-3.5.1.min.js', GENCELL_PLUGIN_URL), array('jquery'), false, true);
	wp_register_script('gencell_jquery_modal', plugins_url('assets/js/jquery.modal.min.js', GENCELL_PLUGIN_URL), array('jquery'), false, true);
