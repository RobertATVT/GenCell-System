...
function gencell_enqueue() {
	...
	wp_register_style('bootstrap_style', plugins_url('assets/css/bootstrap.css', GENCELL_PLUGIN_URL));
	...
	wp_register_script('bootstrapl_js', plugins_url('assets/js/bootstrap.js', GENCELL_PLUGIN_URL), array('jquery'), false, true);
